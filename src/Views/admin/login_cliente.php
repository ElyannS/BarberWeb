                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            ...
                            <div class="col-lg-6" style="background: #e3e3e3;">
                                <div class="p-5 pb-0 mt-0 pt-0" style="background: #e3e3e3;">
                                    <img class="d-lg-none d-xl-none d-xxl-none mt-4" src="<?=URL_BASE?>resources/assets/img/logo%20(4).png" width="150" height="70">
                                </div>
                                <div class="p-5 mt-0 pt-4" style="background: #e3e3e3;">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Bem Vindo!</h4>
                                    </div>
                                    <form action="<?=URL_BASE?>admin/login-cliente" method="post" class="form_ajax user">
                                        <div class="mb-3"><input class="form-control form-control-user" type="email" name="email" id="exampleInputEmail-1" aria-describedby="emailHelp" placeholder="Digite seu E-mail" name="email"></div>
                                        <div class="mb-3"><input class="form-control form-control-user" type="password" name="senha" id="exampleInputPassword-1" placeholder="Digite sua Senha" name="password"></div>
                                        <div class="mb-3">
                                    ...
                                    <div class="text-center"><a class="small" href="<?=URL_BASE?>receber-email">Esqueceu sua senha?</a></div>
                                    <div class="text-center"><a class="small" href="<?=URL_BASE?>register">Criar uma conta</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
