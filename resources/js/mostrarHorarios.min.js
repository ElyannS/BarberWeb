$(document).ready(function(){function i(a,e,o){$.ajax({url:"/admin/mostrar_horarios",type:"POST",data:{data:a,tempoServico:e,idServico:o},dataType:"json",success:function(a){a=a.horarios;$(".itensHorarios").empty(),$.each(a,function(e,o){var a=`
                            <div class="item">
