$(document).ready(function(){function s(e,a,t){$.ajax({url:"/BarberWeb/admin/mostrar_horarios",type:"POST",data:{data:e,tempoServico:a,idServico:t},dataType:"json",success:function(e){e=e.horarios;$(".itensHorarios").empty(),$.each(e,function(a,t){var e=0<t.horarios.length?t.horarios.map(e=>`<span class="span" value="${a},${t.idBarbeiro},${t.idServico},${t.data},${t.nomeServico},${e}">${e}</span>`).join(""):'<p class="sem-horarios">Nenhum horário disponível</p>',e=`
                            <div class="item">
