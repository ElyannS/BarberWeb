$(document).ready(function(){function s(e,a,t){$.ajax({url:"/BarberWeb/admin/mostrar_horarios",type:"POST",data:{data:e,tempoServico:a,idServico:t},dataType:"json",success:function(e){e=e.horarios;$(".itensHorarios").empty(),$.each(e,function(e,a){var t=0<a.horarios.length?a.horarios.map(e=>`<span class="span">${e}</span>`).join(""):'<p class="sem-horarios">Nenhum horário disponível</p>',a=`
                            <div class="item">
                                <div class="nomeBarbeiro">
                                    <img src="http://exclusivebarbershop.com.br/${a.foto_usuario}">
                                    <p>${e}</p>
                                </div>
